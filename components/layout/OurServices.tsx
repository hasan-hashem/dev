...
const services = [
    ...
    },
    {
        icon: <FiTag size={30} />,
        title: "Branding",
        desc: "Random content to fill the blank space",
    },
    {
...
export default function OurServices() {
    return (
        <section
            id="services"
            className="container text-black dark:text-white py-16"
        >
            <div className="max-w-5xl mx-auto text-center px-4">
                ...
                <p className="text-gray-500 mb-12">
                    Transforming your online presence with innovative digital
                    strategies
                </p>
